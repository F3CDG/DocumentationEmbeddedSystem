/**
  **********************************************************************************************
  * @file    	Elaborato3/Elaborato3_1_InterruptBARE/main.c
...
/**
  ...
  * @note   Una volta invocata la routine essa implementa una logica custom, in particolare una volta schicciato il bottone utente si provvede ad incrementare di 1 una variabile e mostrato il conteggio sui led.
  * @param  None.
  * @retval None.
  */
