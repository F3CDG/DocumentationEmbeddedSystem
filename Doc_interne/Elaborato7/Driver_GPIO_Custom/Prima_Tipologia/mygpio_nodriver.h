/**
  ******************************************************************************
  * @file    	Elaborato7/Driver_GPIO_Custom/Prima_Tipologia/mygpio_nodriver.h
...
/**
  ...
  */
typedef struct{
	gpio_custom_TypeDef* gpio_custom;	/*!< Contains virtual address (page offset included) and offset registers value of GPIO */
...
void mygpio_read_gpio(mygpio_TypeDef* mygpio); 	/*!< mygpio_read_gpio function is called to do read operation from GPIO */
