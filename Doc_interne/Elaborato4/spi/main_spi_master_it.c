/**
  ******************************************************************************
  * @file      Elaborato4/spi/main_spi_master_it.c
  * @authors  Colella Gianni - Guida Ciro - Lombardi Daniele / Group IV - Sistemi Embedded 2016-2017
  * @version   V1.0
  * @date      19-June-2017
  * @brief     main che descrive il master di una trasmissione spi
  * @note	In questo programma è configurato il main di una trasmissione SPI.Quando è premuto il push-button si genera una interrupt che fa eseguire la trasmissione di un dato allo slave.
  *******************************************************************************   
*/
