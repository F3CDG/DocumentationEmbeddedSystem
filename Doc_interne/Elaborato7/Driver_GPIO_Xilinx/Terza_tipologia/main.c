/**
  ******************************************************************************
  * @file    	Elaborato7/Driver_GPIO_Xilinx/Terza_Tipologia/main.c
  * @authors	Colella Gianni - Guida Ciro - Lombardi Daniele / Group IV - Sistemi Embedded 2016-2017
  * @version 	V1.0
  * @date    	3-July-2017
  * @brief   	driver "uiointdriver" to control gpio
  ******************************************************************************
*/
...
int main(int argc, char *argv[]){
	...
	if (r_w == READ){
		if(read_gpio(file_descriptor,&r_or_w_value,uio_dev,virt_addr,cha)==-1){
