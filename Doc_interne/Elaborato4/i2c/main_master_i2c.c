/**
  ******************************************************************************
  * @file     Elaborato4/i2c/main_master_i2c.c
  * @authors  Colella Gianni - Guida Ciro - Lombardi Daniele / Group IV - Sistemi Embedded 2016-2017
  * @version   V1.0
  * @date      5-June-2017
  * @brief     main che descrive il master di una trasmissione i2c
  * @note	In questo programma è configurato il main di una trasmissione I2C. Quando è premuto il push-button si genera una interrupt che fa eseguire la trasmissione di un dato allo slave di indirizzo ADDRESS_B.
  *******************************************************************************   
*/
