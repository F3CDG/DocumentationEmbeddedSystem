/**
  ******************************************************************************
  * @file      Elaborato5/Elaborato5_2_Mouse_HID/main.c
  * @authors  Colella Gianni - Guida Ciro - Lombardi Daniele / Group IV - Sistemi Embedded 2016-2017
  * @version   V1.0
  * @date      05-July-2017
  * @brief     esempio di funzionamento di un mouse attraverso la board STM32F4Discovery 
  *******************************************************************************   
*/
#include "main.h"
...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  /*Se la soglia di spostamento è superata allora vengono inviati i 4 byte necessari
	   * allo spostamento del puntatore*/
